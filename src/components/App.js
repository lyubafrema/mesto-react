  ...
  return (
    <div className="root">
      <div className="page">
        ...
        <Footer />
        <PopupWithForm title="Редактировать профиль" name="edit-profile" isOpen={isEditProfilePopupOpen} onClose={closeAllPopups} size="size_l" text="Сохранить">
          <>
        ...
        <PopupWithForm title="Обновить аватар" name="change-avatar" isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups} size="size_m" text="Сохранить">
          <div className="popup__input-container popup__input-container_top">
        ...
        <PopupWithForm title="Новое место" name="add-card" isOpen={isAddPlacePopupOpen} onClose={closeAllPopups} size="size_l" text="Создать">
          <>
            <div className="popup__input-container popup__input-container_top">
        ...
        <PopupWithForm title="Вы уверены?" name="delete-card" onClose={closeAllPopups} size="size_s" text="Да" />
        <ImagePopup card={selectedCard} name="big-image" isOpen={isBigImagePopupOpen} onClose={closeAllPopups} />
      </div>
    </div>
  )
}
